...
// const UserController= requicre("../controllers/UserController")
// const bookController= require("../controllers/bookController")
// const bookController= require("../controllers/myBookController")
...
router.get("/bookList", myBookController.booksList)

router.post("/getBooksInYear/:year", myBookController.getBooksInYear)

router.post("/getParticularBooks", myBookController.getParticularBooks)

router.get("/getXINRBooks", myBookController.getXINRBooks)

router.get("/getRandomBooks", myBookController.getRandomBooks)
